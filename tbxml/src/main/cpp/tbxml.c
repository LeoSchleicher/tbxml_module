...
jlong Java_ru_schleicher_tbxml_TBXML_jniParse(JNIEnv* env,jobject object,jbyteArray xml) {
    ...
    __android_log_print(ANDROID_LOG_INFO,"TBXML","Modified Version #4!");
 ...
 *
 */
void Java_ru_schleicher_tbxml_TBXML_jniFree(JNIEnv* env,jobject object,jlong document) {
 ...
 *
 */
jlong Java_ru_schleicher_tbxml_TBXML_jniRootElement(JNIEnv* env,jobject object,jlong document) {
    TBXMLDocument *doc = (TBXMLDocument *) (uintptr_t) document;
 ...
 *
 */
jlong Java_ru_schleicher_tbxml_TBXML_jniFirstChild(JNIEnv* env,jobject object,jlong document,jlong element) {
    TBXMLDocument *doc  = (TBXMLDocument *) (uintptr_t) document;
 ...
 *
 */
jlong Java_ru_schleicher_tbxml_TBXML_jniChildElementNamed(JNIEnv* env,jobject object,jlong document,jlong element,jstring tag) {
    TBXMLDocument *doc  = (TBXMLDocument *) (uintptr_t) document;
    TBXMLElement  *node = (TBXMLElement  *) (uintptr_t) element;
 ...
 *
 */
jlong Java_ru_schleicher_tbxml_TBXML_jniNextSibling(JNIEnv* env,jobject object,jlong document,jlong element) {
    TBXMLDocument *doc  = (TBXMLDocument *) (uintptr_t) document;
    TBXMLElement  *node = (TBXMLElement  *) (uintptr_t) element;
 ...
 *
 */
jlong Java_ru_schleicher_tbxml_TBXML_jniNextSiblingNamed(JNIEnv* env,jobject object,jlong document,jlong element,jstring tag) {
    TBXMLDocument *doc   = (TBXMLDocument *) (uintptr_t) document;
    TBXMLElement  *node  = (TBXMLElement  *) (uintptr_t) element;
    const char    *name  = (*env)->GetStringUTFChars(env,tag,0);
    TBXMLElement  *child = NULL;
 ...
 *
 */
jstring Java_ru_schleicher_tbxml_TBXML_jniElementName(JNIEnv* env,jobject object,jlong document,jlong element) {
    TBXMLDocument *doc  = (TBXMLDocument *) (uintptr_t) document;
    TBXMLElement  *node = (TBXMLElement  *) (uintptr_t) element;
 ...
 *
 */
jstring Java_ru_schleicher_tbxml_TBXML_jniValueOfAttributeNamed(JNIEnv* env,jobject object,jlong document,jlong element,jstring attribute) {
 ...
 *
 */
jstring Java_ru_schleicher_tbxml_TBXML_jniTextForElement(JNIEnv* env,jobject object,jlong document,jlong element) {
    TBXMLDocument *doc  = (TBXMLDocument *) (uintptr_t) document;
    TBXMLElement  *node = (TBXMLElement  *) (uintptr_t) element;
 ...
 *
 */
jlongArray Java_ru_schleicher_tbxml_TBXML_jniListElementsForQuery(JNIEnv* env,jobject object,jlong document,jlong element,jstring query) {
    TBXMLDocument *doc     = (TBXMLDocument *) (uintptr_t) document;
    TBXMLElement  *node    = (TBXMLElement  *) (uintptr_t) element;
...
TBXMLElement **childElementsForName(TBXMLElement *node,char *tag,int *M) {
    // __android_log_print(ANDROID_LOG_INFO,"TBXML","searching for  %s", tag);
    ...
    while(child) {
        // __android_log_print(ANDROID_LOG_INFO,"TBXML","one %s", child->name);
 ...
 *
 */
jlongArray Java_ru_schleicher_tbxml_TBXML_jniListAttributesForElement(JNIEnv* env,jobject object,jlong document,jlong element) {
    TBXMLDocument *doc  = (TBXMLDocument *) (uintptr_t) document;
    TBXMLElement  *node = (TBXMLElement  *) (uintptr_t) element;
 ...
 *
 */
jstring Java_ru_schleicher_tbxml_TBXML_jniAttributeName(JNIEnv* env,jobject object,jlong document,jlong attribute) {
    const TBXMLDocument  *doc  = (TBXMLDocument  *) (uintptr_t) document;
 ...
 *
 */
jstring Java_ru_schleicher_tbxml_TBXML_jniAttributeValue(JNIEnv* env,jobject object,jlong document,jlong attribute) {
    const TBXMLDocument  *doc  = (TBXMLDocument  *) (uintptr_t) document;
    const TBXMLAttribute *attr = (TBXMLAttribute *) (uintptr_t) attribute;
                        ...
                        if (*chr == '<' && strncmp(chr, "<![CDATA[", 9) == 0) {
                            ...
                            *chr = 0; // set end of string instead of closing quote
                            ...
                            while ((CDATAStart = strstr(value, "<![CDATA["))) {
                                ...
                                __android_log_print(ANDROID_LOG_INFO,"TBXML","Length of attribute: %lu",strlen(CDATAStart));
